// Ported from Reactive Resume (packages/pdf/src/templates/shared/rich-text-spacing.ts)
// Original project: https://github.com/AmruthPillai/Reactive-Resume — MIT License
// Copyright (c) 2026 Amruth Pillai
//
// NOTE: depends on the third-party package `node-html-parser`, which was not in the
// originally specified package list for this project. It must be added to package.json:
