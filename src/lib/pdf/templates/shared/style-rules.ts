// Ported from Reactive Resume (packages/pdf/src/templates/shared/style-rules.ts)
// Original project: https://github.com/AmruthPillai/Reactive-Resume — MIT License
// Copyright (c) 2026 Amruth Pillai

import type { Style } from "@react-pdf/types";
import type { ResumeData, StyleIntent, StyleSlot } from "../../../schema/data";
import type { SectionStyleRuleContext } from "../../../schema/style-rules";
import { getSectionStyleRuleContext, resolveStyleIntentForSlot } from "../../../schema/style-rules";
