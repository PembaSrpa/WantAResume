// Ported from Reactive Resume (packages/pdf/src/hooks/use-register-fonts.ts)
...
import type { ResumeData, Typography } from "../../schema/data";
...
import { isCJKLocale } from "../../utils/locale";
