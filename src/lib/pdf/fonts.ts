// Ported from Reactive Resume (packages/fonts/src/index.ts)
// Original project: https://github.com/AmruthPillai/Reactive-Resume — MIT License
// Copyright (c) 2026 Amruth Pillai
//
// NOTE: @reactive-resume/fonts is an internal monorepo package, not published to npm.
// This file replicates its full exported API, reading font data from the JSON copied
// verbatim from packages/fonts/src/webfontlist.json into ./fonts-data.json.

import { unique } from "../utils/field";
import webFontListJSON from "./fonts-data.json";
