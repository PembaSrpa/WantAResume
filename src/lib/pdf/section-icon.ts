// Ported from Reactive Resume (packages/pdf/src/section-icon.ts)
// Original project: https://github.com/AmruthPillai/Reactive-Resume — MIT License
// Copyright (c) 2026 Amruth Pillai

import type { ResumeData, SectionType } from "../schema/data";
import { getDefaultSectionIconName } from "../schema/section-icons";
