// Ported from Reactive Resume (packages/utils/src/field.ts)
// Original project: https://github.com/AmruthPillai/Reactive-Resume — MIT License
// Copyright (c) 2026 Amruth Pillai
//
// NOTE: not listed in the original porting table, but required by pdf/fonts.ts
// (via the original @reactive-resume/fonts package). Added to keep that import resolvable.
